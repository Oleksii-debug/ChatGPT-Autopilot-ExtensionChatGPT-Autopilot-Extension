const STATE = Object.freeze({
  ...
  FAILED_SAFE: 'ТИМЧАСОВА ПОМИЛКА — ПОВТОР ЗАПЛАНОВАНО',
  NONE: 'НЕМАЄ',
  UNKNOWN: 'НЕВІДОМО',
...
const RUNTIME = [
  ...
  ['Insertion outcome was not confirmed; a safe retry was scheduled.', 'Результат вставлення не підтверджено; автоматичний повтор заплановано.'],
  ['Pre-submit operation was interrupted; a safe retry was scheduled.', 'Операцію перед відправленням перервано; автоматичний повтор заплановано.'],
  ['Interrupted pre-submit operation failed safe; retry scheduled.', 'Перервану операцію перед відправленням переведено в очікування повтору.'],
  ['Interaction transport failed safely', 'Помилка взаємодії з вкладкою; повтор буде виконано за налаштованою політикою'],
  ['Chat interaction failed safely. No result was recorded as sent.', 'Взаємодія з ChatGPT не завершилась. Відправлення не зараховано; стан повтору збережено.'],
