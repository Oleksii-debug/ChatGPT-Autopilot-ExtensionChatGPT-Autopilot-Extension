...
test('AI Manager UI exposes durable trigger and safe-action controls', () => {
  for (const id of [
    ...
    'ai-manager-on-complete','ai-manager-on-errors','ai-manager-error-threshold','ai-manager-handoff-enabled','ai-manager-restart-completed','ai-manager-failure-retry',
